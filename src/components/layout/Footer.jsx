...
import { Github, Linkedin, Twitter, Mail, Handshake, MapPin, Heart, CalendarDays } from "lucide-react";
              ...
              <ul className="space-y-3">
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    ...
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hober:w-2 transition-all duration-300" />
